...
namespace NetBox.Admin.Persistence.Migrations
{
    ...
    [Migration("20240217170734_Current Added NIC and mobile number for user")]
    partial class CurrentAddedNICandmobilenumberforuser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NetBox.Admin.Core.Jobs.DesignerAssignedJob", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("DesignerJobProgress")
                        .IsRequired()
                        .HasMaxLength(64)
            ...
            modelBuilder.Entity("NetBox.Admin.Core.Jobs.Job", b =>
                {
                    ...
                    b.Property<Guid>("CurrentAsigneeId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<DateOnly>("TokenNumberMasterDate")
                        .HasColumnType("date");
                    ...
                    b.HasIndex("TokenNumber", "TokenNumberMasterDate")
                        .IsUnique()
            ...
            modelBuilder.Entity("NetBox.Admin.Core.Jobs.JobTimer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<int>("CumulatedMinutes")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NetBox.Admin.Core.Jobs.DesignerAssignedJob", b =>
                {
                    b.HasOne("NetBox.Admin.Core.Security.Entities.ApplicationUser", "Asignee")
                        .WithMany()
                        .HasForeignKey("AsigneeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("NetBox.Admin.Core.Jobs.Job", "Job")
                        .WithMany("Asignees")
                        .HasForeignKey("JobId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("NetBox.Admin.Core.Jobs.Job", b =>
                {
                    ...
                    b.HasOne("NetBox.Admin.Core.Security.Entities.ApplicationUser", "CurrentAsignee")
                        .WithMany()
                        .HasForeignKey("CurrentAsigneeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("NetBox.Admin.Core.Jobs.JobTimer", b =>
                {
                    b.HasOne("NetBox.Admin.Core.Security.Entities.ApplicationUser", "Designer")
                        .WithMany()
