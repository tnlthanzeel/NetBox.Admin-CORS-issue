...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NetBox.Admin.Domain.Entities.IdentityUserEntities.ApplicationUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("NetBox.Admin.Domain.Entities.IdentityUserEntities.Role", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NetBox.Admin.Domain.Entities.IdentityUserEntities.SP_CheckUserClaim", b =>
                {
            ...
            modelBuilder.Entity("NetBox.Admin.Domain.Entities.IdentityUserEntities.UserClaim", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NetBox.Admin.Domain.Entities.IdentityUserEntities.UserProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NetBox.Admin.Domain.Entities.IdentityUserEntities.UserClaim", b =>
                {
                    b.HasOne("NetBox.Admin.Domain.Entities.IdentityUserEntities.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("NetBox.Admin.Domain.Entities.IdentityUserEntities.UserProfile", b =>
                {
                    b.HasOne("NetBox.Admin.Domain.Entities.IdentityUserEntities.ApplicationUser", "ApplicationUser")
                        .WithOne("UserProfile")
                        .HasForeignKey("NetBox.Admin.Domain.Entities.IdentityUserEntities.UserProfile", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<System.Guid>", b =>
                {
                    b.HasOne("NetBox.Admin.Domain.Entities.IdentityUserEntities.Role", null)
                        .WithMany()
