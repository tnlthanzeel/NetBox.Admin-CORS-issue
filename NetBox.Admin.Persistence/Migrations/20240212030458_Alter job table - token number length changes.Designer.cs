...
namespace NetBox.Admin.Persistence.Migrations
{
    ...
    [Migration("20240212030458_Alter job table - token number length changes")]
    partial class Alterjobtabletokennumberlengthchanges
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("NetBox.Admin.Core.Jobs.Job", b =>
                {
                    ...
                    b.HasIndex("TokenNumberMasterDate", "TokenNumber")
                        .IsUnique()
